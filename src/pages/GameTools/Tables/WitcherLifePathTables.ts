...
export const schoolOptions: option[] = [
  {
    rangeRoof: 2,
...
export const earlyTrainingOptions: option[] = [
  {
    rangeRoof: 1,
...
export const trialsOptions: option[] = [
  {
    rangeRoof: 1,
...
export const mostImportantEventOptions: option[] = [
  {
    rangeRoof: 1,
...
export const currentStatusOptions: option[] = [
  {
    rangeRoof: 1,
  ...
  },
  {
    ...
    value: `Looking For Work
      ...
      of your kind and the extinction of monsters. You travel export constantly and never settle down.`,
  },
  {
    rangeRoof: 8,
